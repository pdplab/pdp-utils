...
class GPUMultiprocessor:
    ...
    def __init__(self, func, df_kwargs, devices, show_pbar=True):
        ...
        :param df_kwargs: a pandas DataFrame containing the arguments to run in the function
            Each column must correspond to a named argument in func
...
def run_func_gpu(func, device, semaphore, return_dict, **kwargs):
    """
    A wrapper function used by GPUMultiprocessor
    """
